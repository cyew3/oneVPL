...
mfxStatus CDecodingPipeline::InitVppParams() {
    ...
    m_mfxVppVideoParams.vpp.In.CropW = 512;
    m_mfxVppVideoParams.vpp.In.Width = MSDK_ALIGN16(512);
    m_mfxVppVideoParams.vpp.In.CropH = 512;
    m_mfxVppVideoParams.vpp.In.Height = 512;
